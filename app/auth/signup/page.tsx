  ...
  if (done) return (
    <div className="min-h-screen bg-[#080810] flex items-center justify-center px-6">
      <div className="text-center max-w-md">
        ...
        <p className="text-slate-400">We sent a confirmation link to <strong>{email}</strong>. Click it to activate your account.</p>
        <Link href="/" className="text-red-400 text-sm mt-6 block hover:text-red-300">← Back to home</Link>
      </div>
    </div>
  );
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
        ...
        <div className="bg-[#0f0f1a] border border-slate-800 rounded-2xl p-8">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            <div>
              <label className="text-xs font-bold text-slate-500 uppercase tracking-widest block mb-2">Company</label>
            ...
            <div>
              <label className="text-xs font-bold text-slate-500 uppercase tracking-widest block mb-2">Work Email</label>
          ...
          <p className="text-center text-slate-600 text-sm mt-6">
            Already have an account? <Link href="/auth/login" className="text-red-400 hover:text-red-300">Sign in</Link>
          </p>
        </div>
      </motion.div>
    </div>
